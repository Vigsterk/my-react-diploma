...
Для добавления необходимо предварительно выбрать размер и количество товаров. Если размер не выбран, добавление товара в Корзину не происходит. Значения параметров по умолчанию: «Размер» — не имеет значения; Количество товаров — **1**.
...
Если в корзине нет товаров, то отображается соответствующее уведомление:

![cart](./resources/images/cart_empty.png)
